...
L42_COMMAND_MAC = "L42.sh"
L42_COMMAND_LINUX = "L42.sh"

HTTP_OK = 200
L42_FORM_FILE_NAME = "index.html"
DIR_L42_PROJECT = "/tmp/L42/L42_project"
EXAMPLE_CODE = """
...
def run_l42_program(l42_binaries, l42_command, code):
    ...
    os.makedirs(DIR_L42_PROJECT, exist_ok=True)
    ...
    stdout, stderr = l42client.communicate(input="exit")
    returncode = l42client.wait()
    os.chdir(wd)
